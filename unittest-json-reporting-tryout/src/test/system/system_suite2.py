...
class Test_system_suite2(unittest.TestCase):
  """
  # helloworld h1
  ...
  def test_sample_269(self):
    """ failed template """
    self.fail("shouldn't happen")

  @unittest.skip("demonstrating skipping")
  def test_sample_270(self):
    """ skipped template """
    self.fail("shouldn't happen")

  @unittest.skip("demonstrating skipping")
  def test_sample_271(self):
    """ skipped template """
    self.fail("shouldn't happen")

  def test_sample_272(self):
    """ failed template """
    self.fail("shouldn't happen")

  def test_sample_273(self):
    """ passed template """
    self.assertTrue(True)

  def test_sample_274(self):
    """ passed template """
    self.assertTrue(True)

  def test_sample_275(self):
    """ passed template """
    self.assertTrue(True)

  @unittest.skip("demonstrating skipping")
  def test_sample_276(self):
    """ skipped template """
    self.fail("shouldn't happen")

  @unittest.skip("demonstrating skipping")
  def test_sample_277(self):
    """ skipped template """
    self.fail("shouldn't happen")

  @unittest.skip("demonstrating skipping")
  def test_sample_278(self):
    """ skipped template """
    self.fail("shouldn't happen")

  def test_sample_279(self):
    """ failed template """
    self.fail("shouldn't happen")

  def test_sample_280(self):
    """ failed template """
    self.fail("shouldn't happen")

  @unittest.skip("demonstrating skipping")
  def test_sample_281(self):
    """ skipped template """
    self.fail("shouldn't happen")

  def test_sample_282(self):
    """ passed template """
    self.assertTrue(True)

  def test_sample_283(self):
    """ passed template """
    self.assertTrue(True)

  def test_sample_284(self):
    """ passed template """
    self.assertTrue(True)

  def test_sample_285(self):
    """ passed template """
    self.assertTrue(True)

  def test_sample_286(self):
    """ passed template """
    self.assertTrue(True)

  @unittest.skip("demonstrating skipping")
  def test_sample_287(self):
    """ skipped template """
    self.fail("shouldn't happen")

  def test_sample_288(self):
    """ passed template """
    self.assertTrue(True)

  def test_sample_289(self):
    """ passed template """
    self.assertTrue(True)

  def test_sample_290(self):
    """ failed template """
    self.fail("shouldn't happen")

  def test_sample_291(self):
    """ failed template """
    self.fail("shouldn't happen")

  def test_sample_292(self):
    """ passed template """
    self.assertTrue(True)

  def test_sample_293(self):
    """ failed template """
    self.fail("shouldn't happen")
